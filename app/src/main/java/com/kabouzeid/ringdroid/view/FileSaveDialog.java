...
public class FileSaveDialog extends Dialog {
    ...
    public FileSaveDialog(Context context,
        ...
        setContentView(R.layout.ringdroid_file_save);

        setTitle(resources.getString(R.string.save_as_title));

        mTypeArray = new ArrayList<String>();
        mTypeArray.add(resources.getString(R.string.alarm));
        mTypeArray.add(resources.getString(R.string.notification));
        mTypeArray.add(resources.getString(R.string.ringtone));
