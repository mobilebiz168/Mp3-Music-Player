package com.kabouzeid.gramophone.ui.fragments.player.one;
...
public class CardPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    public void onPanelStateChanged(View panel, SlidingUpPanelLayout.PanelState previousState, SlidingUpPanelLayout.PanelState newState) {
        switch (newState) {
            case COLLAPSED:
                ...
                imgExpand.setImageResource(R.drawable.ic_expand_less_white_24dp);
                break;
            case ANCHORED:
                ...
                break;
            case EXPANDED:
                imgExpand.setImageResource(R.drawable.ic_expand_more_white_24dp);
                break;
        }
    }
    ...
    private static abstract class BaseImpl implements Impl {
        ...
        public void animateColorChange(int newColor) {
            ...
            fragment.imgExpand.setColorFilter(ATHUtil.resolveColor(fragment.getActivity(), R.attr.iconColor, ThemeStore.textColorSecondary(fragment.getActivity())), PorterDuff.Mode.SRC_IN);
        }
    }
    ...
    private static class PortraitImpl extends BaseImpl {
        ...
        @Override
        public void init() {
            textSongTitle = fragment.getView().findViewById(R.id.textSongTitle);
            textSongArtist = fragment.getView().findViewById(R.id.textSongArtist);

            textSongTitle.setOnClickListener(new SongMenuHelper.OnClickSongMenu((AppCompatActivity) fragment.getActivity()) {
                @Override
                public Song getSong() {
                    return currentSong;
                }
        ...
        public void setUpPanelAndAlbumCoverHeight() {
            ...
            final int minPanelHeight = (int) ViewUtil.convertDpToPixel(65, fragment.getResources());
        ...
        public void updateCurrentSong(Song song) {
            ...
            textSongArtist.setText(MusicUtil.getSongInfoString(song));
        }
        ...
        public void animateColorChange(int newColor) {
            ...
            textSongTitle.setTextColor(MaterialValueHelper.getPrimaryTextColor(fragment.getActivity(), ColorUtil.isColorLight(newColor)));
            textSongArtist.setTextColor(MaterialValueHelper.getSecondaryTextColor(fragment.getActivity(), ColorUtil.isColorLight(newColor)));
        }
    }
}
