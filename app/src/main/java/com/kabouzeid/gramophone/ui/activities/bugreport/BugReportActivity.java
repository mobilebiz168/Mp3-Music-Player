...
public class BugReportActivity extends AbsThemeActivity {
    ...
    private static final String ISSUE_TRACKER_LINK = "https://github.com/mobilebiz168/Mp3-Music-Player";
    ...
    private void sendBugReport(GithubLogin login) {
        ...
        GithubTarget target = new GithubTarget("mobilebiz168", "Mp3-Music-Player");
