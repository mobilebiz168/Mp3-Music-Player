...
import com.kabouzeid.gramophone.RateHelper;
...
import com.kabouzeid.ringdroid.view.RingdroidSelectActivity;
        ...
        navigationView.setNavigationItemSelectedListener(menuItem -> {
            ...
            switch (menuItem.getItemId()) {
                ...
                case R.id.nav_ringtone_cutter:
                    new Handler().postDelayed(() -> startActivity(new Intent(MainActivity.this, RingdroidSelectActivity.class)), 200);
                    break;
            }
            return true;
        });
